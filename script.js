...
downloadButton.addEventListener("click", function () {
    ...
    console.log("=================================");
    console.log("🎬 STEP 8C-3 - OPEN GOOGLE SLIDES");
    console.log("=================================");

    // Get the presentation generated by the automation
    const presentationId =
        localStorage.getItem("generatedPresentationId");

    const presentationUrl =
        localStorage.getItem("generatedPresentationUrl");
    ...
    alert(
        ...
        "4. Wait for Google to finish creating the video\n\n" +
        "After the Vids video is created, we will connect the MP4 download."
    );
